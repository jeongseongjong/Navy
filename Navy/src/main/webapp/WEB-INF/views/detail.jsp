		...
		<div class="row">
			...
			<div class="detail-box"
				...
				<div class="col">
					...
					<p>
						<input id="p_size" value="${productVO.p_size}" /> <input
							id="p_color" value="${productVO.p_color}" />
				</div>
				<div class="col mb-5">
			...
			<div class="row">
				...
				<div class="detail-box"
					...
					<div class="col">
						...
						<div class="dropdownbox">
							<p>컬러를 선택해주세요</p>
							>>>>>>> 0fce65c893b0f1bbef500e9288e3b436fc085236
						</div>
						<c:if test="${!empty productVO.sizeList}">
							<select id="p_size">
		...
		<div class="container">
			...
			<div class="col w3-center mb-5">
				<c:choose>
					<c:when test="${empty productVO.proDImgList}">
						<div style="width: 50%; margin-bottom: 200px;">상품의 디테일정보가
							없습니다.</div>
					</c:when>
					<c:otherwise>
						<img src="${rootPath}/resources/img/dress2.jpg"
							style="width: 50%;" />
						<div style="width: 50%; margin-bottom: 200px;">
							${productVO.proDImgList[0].p_img_upload_name}</div>
			...
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item"><a class="nav-link" id="contact-tab"
					...
					aria-controls="contact" aria-selected="false">Q&A</a></li>
			</ul>
